      ...
      <main className="flex-1">
        <section className="py-20 md:py-32 bg-card/30 border-b border-border/40">
          <div className="container mx-auto px-4 md:px-8 text-center max-w-4xl">
            <ScrollReveal>
              <h1 className="text-4xl md:text-5xl font-extrabold tracking-tight mb-6">Pricing & Packages</h1>
            </ScrollReveal>
        ...
        <section className="py-20 bg-background">
          <div className="container mx-auto px-4 md:px-8 max-w-5xl">
              ...
              <StaggerContainer className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                {packages.map((pkg: any) => (
                  <StaggerItem key={pkg.id}>
                    <div className={`flex flex-col rounded-3xl bg-card p-8 shadow-gold transition-all h-full relative ${pkg.is_popular ? 'border-2 border-primary shadow-gold-heavy transform md:-translate-y-4' : 'border border-primary/10'}`}>
                      {pkg.is_popular && (
            ...
            <ScrollReveal delay={0.3}>
              <div className="mt-16 text-center rounded-[2.5rem] border border-primary/20 bg-card p-8 md:p-12 shadow-gold">
